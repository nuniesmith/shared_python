...
_DEFAULTS: Dict[str, str] = {"APP_ENV": "dev", "LOG_LEVEL": "INFO", "RISK_MAX_PER_TRADE": "0.01", "DEBUG_MODE": "false"}
...
def get_settings() -> Settings:
    ...
    return Settings(APP_ENV=raw["APP_ENV"], LOG_LEVEL=raw["LOG_LEVEL"], RISK_MAX_PER_TRADE=float(raw["RISK_MAX_PER_TRADE"]), DEBUG_MODE=debug_bool, **extras)
