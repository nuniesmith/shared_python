<<<<<<< HEAD
"""Deprecated duplicate of canonical implementation in shared_python.utils.
...
``from shared_python import ...``. All logic delegates to the canonical module.
...
try:  # dual import mode support
    from .config import get_settings  # type: ignore
    from .exceptions import RiskLimitExceeded, DataValidationError  # type: ignore
...
<<<<<<< HEAD
from shared_python.utils import *  # type: ignore F401,F403 re-export intentionally
=======
